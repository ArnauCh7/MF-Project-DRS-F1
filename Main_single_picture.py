'''
================================================================================================================
IMPORTANT!!! This main file is only ment to be executed when using a single body/image,
if you want to do a two body plot execute "Main_multi_picture.py" file.
...
root  = tk.Tk()
root.withdraw()
user_input = simpledialog.askstring(title = "Filename", prompt= "What is the image file name?(and extension): ") #Takes the filename of the picture (plus extension ".png" or ".jpeg")
filename = user_input #Pleas check that you write the correct extension to the filename
...
'''
-----------------------------------------------------------------------------------------------------------------
Fill the grid with Stream Function values except the ones that are inside the body of the picture and
compute the values for Vx and Vy grids
-----------------------------------------------------------------------------------------------------------------
'''
